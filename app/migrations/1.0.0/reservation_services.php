...
/**
 * Class ReservationServicesMigration_100
 */
class ReservationServicesMigration_100 extends Migration
{
    /**
    ...
    {
        $this->morphTable('reservation_services', [
                'columns' => [
                    new Column(
                        'id',
                        [
                ...
                'indexes' => [
                    ...
                    new Index('services_id', ['services_id'], null)
                ],
                'references' => [
                    new Reference(

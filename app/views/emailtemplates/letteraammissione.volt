...
<html>
  <head>
    ...
    <title>Lettera di ammissione per {{ evento }}</title>
    <style>
              ...
              <tr>
                  <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                      <tr>
                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"><img src="http://iscrizioni.falacosagiustaumbria.it/img/logoflcgu.png" style="width: 18vw; max-width: 100px;" alt="Logo Fa la cosa giusta Umbria"></td>
                      </tr>
                    </table>
                  </td>
                </tr>

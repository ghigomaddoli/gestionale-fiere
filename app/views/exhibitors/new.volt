        ...
        <div class="col">
            <h4>Altri servizi</h4>
                ...
                <div class="input-group mb-3">
                    ...
                    {{ numeric_field(nome, 'value' : 0, 'class' : 'form-control', 'id' : identificativo, 'min' : '0', 'max' : '100' ) }}
    ...
    <div class="modal-dialog .modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          {{ link_to('#', "Inserisci ora i dati del tuo co-espositore", 'id' : 'daticoesp', 'class': 'btn btn-primary', 'title' :  "Inserisci ora i dati del tuo co-espositore", 'data-toggle' : 'tooltip') }}
        </div>
      </div>
    </div>
</div>
